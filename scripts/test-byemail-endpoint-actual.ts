/**
 * Test the /search/byemail endpoint to see phone structure
 */
...
async function testByEmail() {
  ...
  const url = 'https://skip-tracing-working-api.p.rapidapi.com/search/byemail?email=nakialove6%40gmail.com&phone=1';
